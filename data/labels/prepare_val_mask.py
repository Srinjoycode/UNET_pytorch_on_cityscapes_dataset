...
for image in images:
    if "labelIds" in image:
        ...
        print(img_name, "--- DONE")
        cv2.imwrite(f"val_mask/{sub_name}mask.png", thresh)
    
print(len(glob.glob("val_mask/*")))
print("You masked Images is stored in './val_mask' successfully! \n You may proceed. \n Thank you")
